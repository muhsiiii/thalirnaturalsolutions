...
<div class="content-wrapper">
    ...
    <label for="name" class="col-sm-3 col-form-label text-right">Name:</label>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <textarea name="desc" class="ckeditor form-control"></textarea>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
        <textarea name="disclaimer" class="ckeditor form-control"></textarea>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
           <input type="text" name="heading" class="form-control" placeholder="Enter Product Name">
        ...
        <div class="form-group row">
         <label for="sub_heading" class="col-sm-3 col-form-label text-right">Sub Heading:</label>
          <div class="col-sm-6">
             <input type="text" name="sub_heading" class="form-control" placeholder="Enter Product Sub Heading">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" name="features" class="form-control" placeholder="Enter Product Features">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-2 offset-sm-3">
            <img id="showimage4" class="img-thumbnail hide" width="75%" height="auto" style="min-width:140px;">
			  ...
			  <div class="form-group row">
          <label for="image5" class="col-sm-3 col-form-label text-right">Product Image5 :</label>
          <div class="col-sm-6 col-10">
            <div class="input-group">
              <div class="custom-file">
          ...
          <div class="col-sm-1 col-2">
            <button type="button" class="btn btn-secondary btn-tooltip float-left" data-toggle="tooltip" data-placement="top" title="Product in Aspect Ratio of 4:5 Required. ie Image with Resolution 200 x 250px, 300 x 375px etc.">
			  ...
			  <div class="row">
          <div class="col-sm-2 offset-sm-3">
            <img id="showimage5" class="img-thumbnail hide" width="75%" height="auto" style="min-width:140px;">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-2 offset-sm-3">
            <img id="showimage6" class="img-thumbnail hide" width="75%" height="auto" style="min-width:140px;">
          </div>
        </div>
  ...
  if ((file = this.files[0])) {
    ...
    img.onload = function () {
      ...
      if (res < 0.60 || res > 1.10) {
        ...
        $('#helpimage2').html('Product in Aspect Ratio of 1:1,4:5 Required. ie Image with Resolution 200 x 200px,200 x 250px, 300 x 375px etc.').removeClass('hide');
      } else {
  ...
  if ((file = this.files[0])) {
    ...
    img.onload = function () {
      ...
      if (res < 0.60 || res > 1.10) {
        ...
        $('#helpimage3').html('Product in Aspect Ratio of 1:1,4:5 Required. ie Image with Resolution 200 x 200px,200 x 250px, 300 x 375px etc.').removeClass('hide');
      } else {
  ...
  if ((file = this.files[0])) {
    ...
    img.onload = function () {
      ...
      if (res < 0.60 || res > 1.10) {
        ...
        $('#helpimage4').html('Product in Aspect Ratio of 1:1,4:5 Required. ie Image with Resolution 200 px 200px,200 x 250px, 300 x 375px etc.').removeClass('hide');
      } else {
  ...
  if ((file = this.files[0])) {
    ...
    img.onload = function () {
      ...
      if (res < 0.60 || res > 1.10) {
        ...
        $('#helpimage5').html('Product in Aspect Ratio of 1:1,4:5 Required. ie Image with Resolution 200 px 200px,200 x 250px, 300 x 375px etc.').removeClass('hide');
      } else {
  ...
  if ((file = this.files[0])) {
    ...
    img.onload = function () {
      ...
      if (res < 0.60 || res > 1.10) {
        ...
        $('#helpimage6').html('Product in Aspect Ratio of 1:1,4:5 Required. ie Image with Resolution 200 px 200px,200 x 250px, 300 x 375px etc.').removeClass('hide');
      } else {
