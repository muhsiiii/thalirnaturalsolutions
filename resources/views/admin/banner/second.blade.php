          ...
          <div class="modal-body">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <button type="button" class="btn btn-secondary btn-tooltip float-left" data-toggle="tooltip" data-placement="top" title="Please upload in any same resolution.">
  ...
  $('#image').change(function (e) {
    ...
    if ((file = this.files[0])) {
      ...
      img.onload = function () {
        ...
        // if (res < 1.45 || res > 1.55) {
        //   $('#image').addClass('is-invalid').val('');
        //   $('#showImage').addClass('hide');
        //   $('#helpImage').html('Image in Aspect Ratio of 3:2 Required.').removeClass('hide');
        // } else {
