                    ...
                    <td align="center">
                      <div class="row">
                        <div class="col-sm-6" align="right">
                          <a href="" class="btn btn-sm btn-default btn-warning" data-toggle="modal" data-target="#modal-add" title="Edit Banner" onclick="mkeEditForm('{{$value->id}}','{{$value->image}}','{{$value->name}}','{{$value->url}}')">
                        ...
                        <div class="col-sm-6" align="left">
                          <form action="{{url('/admin/banners/delete/third/'.$value->id)}}" method="POST" role="form">
                            {!! csrf_field() !!}
                            <button type="submit" class="btn btn-sm btn-default btn-delete" title="Delete Banner">
          ...
          <div class="modal-body">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <button type="button" class="btn btn-secondary btn-tooltip float-left" data-toggle="tooltip" data-placement="top" title="Image in Ratio of 1:1 Required, ie Resolution 640*360px, 1280*720px ..etc.">
  ...
  $('#image').change(function (e) {
    ...
    if ((file = this.files[0])) {
      ...
      img.onload = function () {
        ...
        if (res < 1.70 || res > 1.85) {
          $('#image').addClass('is-invalid').val('');
          $('#showImage').addClass('hide');
          $('#helpImage').html('Image in Aspect Ratio of 16:9 Required.').removeClass('hide');
        } else {
